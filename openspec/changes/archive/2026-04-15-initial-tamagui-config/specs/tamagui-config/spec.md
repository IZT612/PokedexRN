...
The Tamagui configuration MUST define shared tokens for brand colors, Pokémon type colors, typography, and spacing that match the PRD design system values.
